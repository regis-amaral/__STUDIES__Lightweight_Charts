...
var ChartManager = /*#__PURE__*/function () {
  function ChartManager(domElement) {
   ...
   */
  return _createClass(ChartManager, [{
    key: "initializeChart",
    value: function initializeChart() {
      ...
      this.chart = (0,lightweight_charts__WEBPACK_IMPORTED_MODULE_0__.createChart)(this.domElement, chartProperties);
    ...
    key: "loadData",
    value: (function () {
      var _loadData = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(jsonData) {
        var data;
    ...
    key: "updateData",
    value: (function () {
      var _updateData = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee2(newData) {
        var _this = this;
              ...
              try {
                ...
                if (Array.isArray(newData)) {
                  newData.forEach(function (candle) {
                    _this.candlestickSeries.update(candle);
                  });
                } else {
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (ChartManager);
...
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _ChartManager_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./ChartManager.js */ "./src/js/ChartManager.js");


// REFERENCIA O ELEMENTO HTML ONDE O GRÁFICO SERÁ RENDERIZADO
var domElement = document.getElementById("lightweight-chart");

// INSTANCIA A CLASSE ChartManager
var chartManager = new _ChartManager_js__WEBPACK_IMPORTED_MODULE_0__["default"](domElement);
...
/******/ 		}
/******/ 		
/******/ 		var chunkLoadingGlobal = self["webpackChunk_02_candlestick_com_classe_especializada"] = self["webpackChunk_02_candlestick_com_classe_especializada"] || [];
...
/******/ 	__webpack_require__.O(undefined, ["css/styles"], () => (__webpack_require__("./src/js/ChartManager.js")))
